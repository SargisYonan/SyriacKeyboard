...
# @file setup.command
#
# @brief Enable the built-in Assyrian keyboard or install the legacy keyboard on a Mac
# @usage ./setup.command
#
...
BUILTIN_LAYOUT_ID="-30291"
BUILTIN_LAYOUT_NAME="Syriac-QWERTY"
LEGACY_LAYOUT_ID="0x0001045a"
LEGACY_LAYOUT_NAME="Syriac Phonetic"
LEGACY_LAYOUT_FILE="$INSTALL_DIR/legacy/SyriacPhonetic.rsrc"
...
if [ "$MACOS_MAJOR_VERSION" -ge 12 ]; then
    echo "Enabling the built-in Assyrian keyboard on the system..."
    ...
    echo "macOS $(sw_vers -productVersion) does not include the built-in Assyrian keyboard."
